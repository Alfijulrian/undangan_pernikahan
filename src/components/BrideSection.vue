<template>
  <section class="groom-profile">
    ...
    <div ref="profileCard" :class="['profile-card', { visible: isVisible }]">
      ...
      <img src="/images/f_cewek.jpg" alt="Suci RahmadiniAldes Fitra Ramadhan" class="photo" />

      <!-- Nama -->
      <h2 class="name">Suci Rahmadini</h2>

      <!-- Nama Orang Tua -->
      <p class="parents">Putri dari Bapak Khairudin & R. Julinar</p>

      <!-- Instagram -->
      <a href="https://www.instagram.com/ciirhmadini_?igsh=MzRoaWVpdTZpZXZ5" target="_blank" class="ig">
